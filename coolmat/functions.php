...
if ( ! function_exists( 'coolmat_setup' ) ) :
	...
	function coolmat_setup() {
		 ...
		 */
		add_theme_support( 'post-thumbnails' ); //aka featured images of posts
...
function coolmat_scripts() {
	//paramters to add css style - unique name, 
	//get_stylesheet_uri - looks inside theme and looks for style.css
	...
	// wp_enqueue_style( 'slider', get_template_directory_uri() . '/css/slider.css',false,'1.1','all'); //sample from wordpress docs
